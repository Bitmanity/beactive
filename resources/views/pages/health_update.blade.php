...
@endsection
@section('content')
    <form action="{{route('add_body_info',$client->id)}}" method="post">
        {{csrf_field()}}
            ...
            <div class="col-lg-12">
                <div class="card card-default">
                    <div class="card-header ">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="bold">{{$client->first_name}} {{$client->last_name}}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group form-group-default form-group-default-select2">
                                                ...
                                                <select name="energy" class="full-width"
                                                        data-placeholder="Select Levels" data-init-plugin="select2">
                    ...
                    <div class="card-footer">
                        <input class="btn btn-primary btn-cons btn-animated from-left fa fa-truck pull-left"
                               type="submit">
