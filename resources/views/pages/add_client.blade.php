                                        ...
                                        <div class="col-8">
                                            <div class="form-group form-group-default input-group">
                                                <div class="cs-input-group-addon input-group-addon d-flex">
                                                    <select class="cs-select cs-skin-slide cs-transparent"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group form-group-default input-group bootstrap-timepicker">
                                                ...
                                                <input id="timepicker6" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-4"></div>
                                    </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="checkbox check-primary">
                                                    <input type="checkbox" value="1" id="smoking">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="checkbox check-primary">
                                                    <input type="checkbox" value="1" id="appetite">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="checkbox check-primary">
                                                    <input type="checkbox" value="1" id="digestion">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="checkbox check-primary">
                                                    <input type="checkbox" value="1" id="acidity">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="checkbox check-primary">
                                                    <input type="checkbox" value="1" id="medication">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="checkbox check-primary">
                                                    <input type="checkbox" value="1" id="highBP">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="checkbox check-primary">
                                                    <input type="checkbox" value="1" id="LowBP">
                    ...
                    <div class="row row-same-height">
                        <div class="col-md-5 b-r b-dashed b-grey ">
                            <div class="padding-30 sm-padding-5 sm-m-t-15 m-t-50">
                                ...
                                <p>We respect your privacy and protect it with strong encryption, plus strict
                                    policies.</p>
